(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-tricks__slider")) new core(".slider-tricks__slider", {
            ...
            navigation: {
                prevEl: ".slider-tricks .slider-arrow_prev",
                nextEl: ".slider-tricks .slider-arrow_next"
            },
            breakpoints: {
                767.98: {
                    slidesPerView: 2,
